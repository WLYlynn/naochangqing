...
# (str) Package name
package.name = naochangqing

# (str) Package domain (needed for android/ios packaging)
package.domain = com.54321

# (str) Source code where the main.py live
source.dir = .

# (list) Source files to include (leave empty to include all the files)
source.include_exts = py,png,jpg,jpeg,gif,html,css,js,json,txt,md
...
requirements = python3,fastapi,uvicorn,librosa,numpy,soundfile,requests,websocket-client

p4a.bootstrap = webview
p4a.entrypoint = app:app
p4a.port = 8000
